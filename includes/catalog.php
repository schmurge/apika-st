				...
				<?php foreach ($products as $product) : ?>
					<div class="col-md-4">
						<a href="/catalog.php?product=<?php echo $product['id']; ?>">
							<div class="grey-box">
								<img src="http://dummyimage.com/265x150/<?php echo $colors[count($products)+$product['id']]; ?>/<?php echo $colors[count($products)+$product['id']+10]; ?>.gif&text=<?php echo $product['label']; ?>">
	...
	<div class="row">
		<div class="col-md-10 col-md-offset-1">
			...
			<?php for ($i = 0; $i < 15; $i++) : ?>
				<div class="col-md-4">
					<div class="grey-box">
						<a href="http://dummyimage.com/1060x600/<?php echo $colors[count($products)+$i]; ?>/<?php echo $colors[count($products)+$i+10]; ?>.gif&text=no image" data-lightbox="image-1" data-title="My caption">
							<img src="http://dummyimage.com/265x150/<?php echo $colors[count($products)+$i]; ?>/<?php echo $colors[count($products)+$i+10]; ?>.gif&text=no image">
						</a>
					</div>
				</div>
			<?php endfor; ?>
